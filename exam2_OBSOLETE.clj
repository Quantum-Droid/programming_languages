...
(defn pizza
  ...
  [l]
  (def p-a (get-cost-per-sqIn (first l)))
  (def p-b (get-cost-per-sqIn (second l)))
  (def p-c (get-cost-per-sqIn (last l)))
  (def min-pizza (min p-a p-b p-c))
  (cond
    (= min-pizza p-a) (first (first l))
    (= min-pizza p-b) (first (second l))
    (= min-pizza p-c) (first (last l))))
